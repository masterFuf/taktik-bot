...
- Dans les services plateforme, regrouper les familles de flow sous un sous-package nomme plutot qu'une liste plate prefixee. Exemple : les services TikTok publish vivent sous `social_media/tiktok/services/publish/**`, pas sous `services/publish_*.py`.
