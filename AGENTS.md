...
- Dans les services plateforme, regrouper les familles de flow ou de surface sous un sous-package nomme plutot qu'une liste plate prefixee. Exemples : les services TikTok publish vivent sous `social_media/tiktok/services/publish/**`, les services followers sous `social_media/tiktok/services/followers/**`, et les services profil sous `social_media/tiktok/services/profile/**`.
