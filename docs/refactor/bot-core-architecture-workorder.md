...
- un sous-lot suivant demarre l'extraction Instagram automation sans brancher de handler premature : le mapping config bridge-compatible quitte `desktop_bridge.py` pour `social_media/instagram/workflows/core/config_builder.py`, ce qui clarifie l'owner metier tout en preservant le startup bridge et stdout JSON.
