...
def build_for_you_config(for_you_config_class, config: Dict[str, Any]):
    ...
    return for_you_config_class(
        ...
        training_keywords=config.get("trainingKeywords") or [],
        training_reject_off_niche=config.get("trainingRejectOffNiche", True),
        max_rejections_per_session=config.get("maxRejectionsPerSession", 20),
