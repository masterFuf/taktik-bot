...
from taktik.core.media.capture import MediaCaptureService as LegacyMediaCaptureService
from taktik.core.media.proxy import ProxyManager as LegacyProxyManager
