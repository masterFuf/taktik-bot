...
The runtime owner is `taktik.core.ai.providers.openrouter`. Bridges can import the
canonical owner directly; this module only keeps historical imports working.
"""

from taktik.core.ai.providers.openrouter import AIService, DEFAULT_TEXT_MODEL, DEFAULT_VISION_MODEL
