...
from .migration_steps.social_posts import (
    run_social_posts_identity_migration,
    run_social_posts_migrations,
)
...
def run_migrations(conn: sqlite3.Connection) -> None:
    ...
    run_social_posts_identity_migration(cursor)  # post_key: identity apart from the URL
