...
- Sous `bridges/common/**`, classer par capacite de bridge (`device`, `input`, `runtime`, `persistence`, etc.) au lieu d'ajouter de nouveaux modules plats. Exemple : le reset reseau bridge vit sous `bridges/common/device/network.py`.
