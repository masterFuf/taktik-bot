...
UNFOLLOW_DEFAULTS: Dict[str, Any] = {
    'max_unfollows': 20,
    'unfollow_delay_range': (2, 5),  # seconds; fast by default, prudence is in the volume caps
    ...
    'skip_verified': True,
    'skip_business': False,
    'bot_follows_only': True,  # manual follows are protected unless the user says otherwise
    'whitelist': [],
    'blacklist': [],
}
