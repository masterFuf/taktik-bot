...
| P1 Process runner uniforme | 93% | TikTok workflow, scraping Instagram et automation Instagram sont largement externalises. Cote Electron, Persona Analysis, Taktik Agent et Cold DM sont maintenant des facades IPC deleguant access/bridge/launch/runtime/workflow selon leur famille, et Smart Comment a ses owners events/launch/runtime. Reste extraction workflow Smart Comment, certains outils compat/debug et la decision long terme runner unique vs exceptions documentees. |
...
Estimation globale actuelle : environ **77%** du chantier front/Electron
