...
- Dans les services plateforme, regrouper les familles de flow sous un sous-package nomme plutot qu'une liste plate prefixee. Exemples : les services TikTok publish vivent sous `social_media/tiktok/services/publish/**`, et les services followers sous `social_media/tiktok/services/followers/**`.
