...
>
> **Premium Desktop App** — Full-featured application with GUI, AI tools, and multi-account management
>
...
Local POC and device smoke scripts belong under `tests/poc/` and `tests/smoke/`.
