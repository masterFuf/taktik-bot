...
- Pour les facades legacy mono-plateforme comme `taktik/core/recorder`, preferer une facade package-level `__init__.py` plutot qu'un module racine additionnel si aucun consommateur runtime interne n'utilise l'ancien sous-module.
